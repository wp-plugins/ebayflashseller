...
define('EBAY_FLASH_SELLER_PLUGIN_URL', plugin_dir_url( __FILE__ ));
define('EBAY_FLASH_SELLER_PLUGIN_PATH', dirname( __FILE__ ));
define('EBAY_FLASH_SELLER_PLUGIN_VAR_NAME', "ebay_flash_seller_configuration");

function ebay_flash_seller_get_proxy_url(){
